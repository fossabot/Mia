...
public class HTMLtoPDF: NSObject {
    ...
    fileprivate var completionBlock: HTMLtoPDFBlock?
    ...
    public class func save(url: URL, pageSize: PageSize, isLandscape landscape: Bool, completion: @escaping HTMLtoPDFBlock) -> HTMLtoPDF {
        ...
        pdfKit.completionBlock = completion
        pdfKit.save(url: url)
        return pdfKit
    }
    ...
    fileprivate func savePdf() {
        ...
        self.completionBlock?(currentReportData as Data, nil)
...
// MARK: - HTMLtoPDFPrintPageRenderer
