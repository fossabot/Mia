...
public struct Device {
    ...
    @available(*, deprecated, message: "Use `DeviceKit.Battery` instead.")
    ...
    @available(*, deprecated, message: "Use `DeviceKit.Hardware` instead.")
    public struct `Type` {

        /// Determines whether see if device is an iPhone
        public static var isPhone: Bool {

            return UIDevice.current.userInterfaceIdiom == .phone
        }

        /// Determines whether see if device is an iPad
    ...
    @available(*, deprecated, message: "Use `DeviceKit.Screen` instead.")
    public struct Size {
        ...
        /// Determines whether device screen size is equal a specific screen size
        ///
        ...
        /// Determines whether device screen size is larger or equal to a specific screen size
        ///
        /// - Parameter size: The size to check against.
        ...
        /// Determines whether device screen size is smaller or equal to a specific screen size
        ///
        /// - Parameter size: The size to check against.
    ...
    @available(*, deprecated, message: "Use `DeviceKit.Network` instead.")
    ...
    @available(*, deprecated, message: "Use `#available(iOS 9.0, *)` instead.")
    public struct Firmware {
        ...
        /// Determines whether device is on a specific firmware.
        ///
        ...
        /// Determines whether device is on a specific firmware or later.
        ///
        /// - Parameter version: The firmware to check against.
        ...
        /// Determines whether device is earlier than a specific firmware.
        ///
        /// - Parameter version: The firmware to check against.
    ...
    @available(*, deprecated, message: "Use `DeviceKit.Settings` instead.")
