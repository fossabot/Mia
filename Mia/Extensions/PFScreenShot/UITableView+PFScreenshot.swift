...
public extension PFSceenshot where Base: UITableView {
   ...
   public func screenshotIncluded(tableViewHeaderIncluded: Bool = true,
    ...
    public func screenshotExcluding(tableViewHeaderExcluding: Bool = true,
    ...
    public func screenshotOfCell(at indexPath: IndexPath, included selectedType: SelectedType<Set<IndexPath>> = .all) -> UIImage? {
    ...
    public func screenshotOfCell(at indexPath: IndexPath, excluding selectedType: SelectedType<Set<IndexPath>>) -> UIImage? {
    ...
    public func screenshotOfTableViewHeaderView() -> UIImage? {
        guard let headerRect = base.tableHeaderView?.frame else { return nil }
        return screenshotTableView(for: headerRect)
    }
    
    public func screenshotOfTableViewFooterView() -> UIImage? {
        guard let footerRect = base.tableFooterView?.frame else { return nil }
        return screenshotTableView(for: footerRect)
    }
    
    public func screenshotOfSectionHeaderView(atSection section: Int, included selectedType: SelectedType<Set<Int>> = .all) -> UIImage? {
    ...
    public func screenshotOfSectionHeaderView(atSection section: Int, excluding selectedType: SelectedType<Set<Int>>) -> UIImage? {
    ...
    public func screenshotOfSectionFooterView(atSection section: Int, included selectedType: SelectedType<Set<Int>> = .all) -> UIImage? {
        if case .specific(let sections) = selectedType,
            !sections.contains(section) {
            return nil
        }
    ...
    public func screenshotOfSectionFooterView(atSection section: Int, excluding selectedType: SelectedType<Set<Int>>) -> UIImage? {
        guard case .specific(let sections) = selectedType,
            !sections.contains(section) else {
            return nil
        }
