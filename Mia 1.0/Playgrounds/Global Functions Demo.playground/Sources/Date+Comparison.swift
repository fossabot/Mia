...
extension Date {
     ...
     */
    public func isSameDay(as compareDate: Date) -> Bool {
     ...
     */
    public func years(from date: Date, calendar: Calendar = Calendar.autoupdatingCurrent) -> Int {
     ...
     */
    public func months(from date: Date, calendar: Calendar = Calendar.autoupdatingCurrent) -> Int {

        let earliest = earlierDate(date)
        let latest = (earliest == self) ? date : self;
        let multiplier = (earliest == self) ? -1 : 1;
        let components = calendar.dateComponents(Constants.AllCalendarUnitFlags, from: earliest, to: latest)
     ...
     */
    public func weeks(from date: Date, calendar: Calendar = Calendar.autoupdatingCurrent) -> Int {
     ...
     */
    public func days(from date: Date, calendar: Calendar = Calendar.autoupdatingCurrent) -> Int {
